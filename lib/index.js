/**
 *
 * @param {array} cases an array of objects of the following form {case:<predicate function or regex>,value:<value to return>,object:<required if options.objects is true>}
